...
deleteStudent = studentId =>
    studentModel.remove({_id: studentId}).then(console.log("Student Deleted."));
...
deleteQuestion = questionId =>
    questionModel.remove({_id: questionId}).then(console.log("Question Deleted."));

answerQuestion = (answer) =>
    answerModel.create(answer);

deleteAnswer = answerId =>
    answerModel.remove({_id: answerId}).then(console.log("Answer Deleted."));

deleteAnswerByQuestion = questionId =>
    answerModel.remove({question: questionId}).then(console.log("Answer Deleted."));

deleteAnswerByStudent = studentId =>
    answerModel.remove({student: studentId}).then(console.log("Answer Deleted."));
...
findAnswerByStudent = studentId =>
    answerModel.find({studentId: studentId});

findAnswerByQuestion = questionId =>
    answerModel.find({questionId: questionId});
